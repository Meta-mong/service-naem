...
public class ConcertServiceTest {
    ...
    @Test
    public void 공연수정(){
        ConcertDto concertDto = concertService.concertInfo(3L);
        concertDto.setSeat_num(300);
        concertService.updateConcert(concertDto,3L);
        System.out.println(concertService.concertInfo(3L).toString());
    }

    @Test
    public void 공연삭제(){
        concertService.deleteConcert(3L);
