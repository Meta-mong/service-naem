...
public class KakaoPay {
    ...
    public String kakaoPayReady() {
        ...
        params.add("approval_url", "http://localhost/payment/kakao/success"); // 결제 성공 시 redirect url
        params.add("cancel_url", "http://localhost/payment/kakao/cancel"); // 결제 취소 시 redirect url
        params.add("fail_url", "http://localhost/payment/kakao/fail");  // 결제 성공 시 redirect url
